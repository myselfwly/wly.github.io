...
interface ProjectNamePropsType extends Pick<WorkInfoType, "projectName"> {}
/** */
export const ProjectName: FC<ProjectNamePropsType> = ({ projectName }) => {
	return (
		<ProjectNameWarpper>
			<div className="bg_main">
				<div className="block_bg"></div>
				<div className="arror_bg"></div>
				{/* <div className="arror_bg offect"></div> */}
			...
			<div className="textContain">{projectName}</div>
		</ProjectNameWarpper>
	);
};
//style_components
const ProjectNameWarpper = styled.div`
	height: 100%;
	text-indent: 1rem;
	position: relative;
	.bg_main {
